...
export default function OwnerProfile() {
  ...
  // Conditionally render houses or message based on loading state and houses array
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-screen-lg mt-3">
        {loading ? (
          ...
          <p  className="text-center text-xl font-bold">Oops! No houses found. Please add houses.</p>
        ) : (
