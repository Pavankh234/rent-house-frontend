    ...
    return (
        <div className="flex flex-col items-center mt-8">
            ...
            <div className="bg-white rounded-lg p-6 mb-4 shadow-md border-l-4 border-yellow-500">
                <ul className="list-none text-xl p-0">
                    {reminders.map(reminder => (
                        <li key={reminder.house_id} className="flex items-center my-2">
                            <div className="bg-gray-800 rounded-md p-2 mr-4">House ID {reminder.house_id}</div>
                            <div className="bg-gray-800 rounded-md p-2">Next Payment Due: {reminder.next_payment_due_date}</div>
                        </li>
                    ))}
                </ul>
            </div>
