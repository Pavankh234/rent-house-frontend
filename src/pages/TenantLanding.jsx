...
//   return (
//     <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center py-16">
//       <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center bg-indigo-300 shadow-md">
//         <img className="h-10 w-auto" src={Logo} alt="Your Company" />
//         <div className="flex items-center space-x-7">
//           <img
//             src="bell.png"
//             alt="Bell Icon"
//             className="w-8 h-8 text-gray-600 hover:text-gray-400 cursor-pointer"
//             onClick={handleRemainderClick}
//           />
//           <img
//             src="profileicon.png"
...
//         <h1 className="text-3xl font-bold text-gray-800 text-center mb-8">Welcome Search Your Houses Below</h1>
//         <div className="flex items-center space-x-4">
//           <input
//             type="text"
//             placeholder="Location"
...
export default function TenantLanding() {
  ...
  const [isSearching, setIsSearching] = useState(false);
  const [rent, setRent] = useState("");
  const [noHousesMessage, setNoHousesMessage] = useState(false);
  const navigate = useNavigate();
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.length === 0) {
          setNoHousesMessage(true);
        } else {
          setNoHousesMessage(false);
        }
      })
      .catch((error) => {
        console.error("Error searching houses:", error);
      ...
      <div className="flex flex-col items-center space-y-8 mt-20">
        ...
        <div className="w-full max-w-screen-lg mt-8">
          {noHousesMessage && (
            ...
            <p className="text-gray-800 text-lg font-semibold">No houses available in this area currently.</p>
          </div>
          )}
          {!noHousesMessage && searchResults.map((house, index) => (
            <div
              key={index}
              className="bg-white rounded-lg p-6 mb-4 shadow-md border-l-4 border-indigo-500"
            >
